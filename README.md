...
Este é um projeto e-commerce completo desenvolvido em ASP.NET arquitetado por camadas. Ele está pronto para quem quiser configurá-lo e disponibiliza-lo em produção, seja qual for o tipo de produto para vender.
...
This is a complete e-commerce project developed in ASP.NET and architected by layers. It is ready for anyone who wants to configure it and make it available in production, whatever the type of product to sell.
